            ...
            <div className="results-list">
              {displayedResults.map((result) => (
                <div 
                  ...
                  onClick={() => handleVideoSelect(result.id, result.startTime)}
                >
                  <div className="result-left">
                    <div className="result-thumbnail-small">
                      ...
                      <span className="duration-badge-small">
                        {result.startTime ? formatTime(result.startTime) : result.duration}
                      </span>
                    </div>
                  </div>
              ...
              >
                <div className="featured-thumbnail">
                  ...
                  <span className="duration-badge">
                    {discussion.startTime ? formatTime(discussion.startTime) : discussion.duration}
                  </span>
                </div>
